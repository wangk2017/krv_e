...
veri:
	verilator -Wall +incdir+./tb +incdir+./tb/sim_inc --cc ./tb/rom.v ./verification/krv_e_tb.v ./src/rtl/*/*.v  ./src/Actel_DirectCore/*.v --exe ./verification/sim_main.cpp
	make -j -C obj_dir -f Vkrv_e_tb.mk Vkrv_e_tb
